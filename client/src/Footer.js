...
function Footer() {
  ...
  <footer className="footer">
    ...
    <span className="footer__companyName"><CopyrightIcon className="footer__copyrightIcon" /> 2020 | Gravity LEDs</span>
    </div>
    <div className="footer__policies">
      <span className="footer__policy">All Rights Reserved</span>
    </div>
